...
<body>
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="../img/cafe2.jpg" alt="HOME - Café Mulato Orgánico" id="cafe" class="img-fluid rounded-start">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        ...
        <center>
            ...
            <h1>Finca Loma - Café Green Hills</h1><br>
                ...
                tol.readOnly = true;
                    function calcular(){
                        try {
                            ...
                            document.getElementById("tol").value = a * 15500;
                        }catch (e) {}
			...
			location.href = '../vista/comprar2.php';</script>";
			}
				
			else{
		
			$query = mysqli_query($conectar, "INSERT INTO ventas (nombre,cantidad,precio_unit,total) values ('Finca Loma - Café Green Hills', '$cantidad','15500','$total')");	
